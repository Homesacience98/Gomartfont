    ...
    <div  class= 'row'>
      ...
      <Carousel.Item>
        <img
          ...
          src={`https://itssaj.pythonanywhere.com/${femaleItem.image}`}
          alt="First slide"
        />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={`https://itssaj.pythonanywhere.com/${femaleItem.img1}`} 
          alt="Second slide"
        />
        <Carousel.Caption>
          <h5>{femaleItem.name}</h5>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={`https://itssaj.pythonanywhere.com/${femaleItem.img2}`}
...
<div className='container'>
  <Row className="justify-content-md-left">
    <Col xs={4} lg={2}><Image className="img-fluid" src={`https://itssaj.pythonanywhere.com/${femaleItem.image}`} alt="Image 1"/></Col>
    <Col xs={4} lg={2}><Image className="img-fluid" src={`https://itssaj.pythonanywhere.com/${femaleItem.img1}`} alt="Image 1"/></Col>
    <Col xs={4} lg={2}><Image className="img-fluid" src={`https://itssaj.pythonanywhere.com/${femaleItem.img2}`} alt="Image 1"/></Col>
  </Row>
  <br/>
  <hr/>
