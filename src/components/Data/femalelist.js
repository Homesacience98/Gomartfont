...
function Femalelist({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'F').map((maleclothesItem) => (
    <Col
  ...
  return (
    <div  className='container'>
        <Search/>
        <hr/>
 <h6> &nbsp;  Female <i style={{color:'pink'}} class="fa fa-gear fa-spin" ></i> </h6>
