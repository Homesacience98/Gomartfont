...
import NF_LOGO from '../../images/logopal.png'
import ClothingDetail from '../Data/detail';


function QuickPalace({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Palace').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='palace'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'60px',height:' 50x',color:'grey'}} src={NF_LOGO}></img></a> 
