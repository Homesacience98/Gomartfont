...
import NF_LOGO from '../../images/logoth.jpg'
import ClothingDetail from '../Data/detail';


function QuickTh({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Tommy Hilfiger').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='th'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:'50x',color:'grey'}} src={NF_LOGO}></img></a> 
