...
import NF_LOGO from '../../images/er.png'
import ClothingDetail from '../Data/detail';


function QuickKeppa({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Keppa').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='keppa'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:' 50x',color:'grey'}} src={NF_LOGO}></img></a> 
