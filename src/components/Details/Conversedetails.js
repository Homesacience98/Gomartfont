...
import NF_LOGO from '../../images/555.png'
import ClothingDetail from '../Data/detail';


function QuickConverse({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Converse').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='converse'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:' 40x',color:'grey'}} src={NF_LOGO}></img></a> 
