...
import NF_LOGO from '../../images/pm.jpg'
import ClothingDetail from '../Data/detail';


function QuickPuma({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Puma').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='puma'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:'50px',color:'grey'}} src={NF_LOGO}></img></a> 
