...
import NF_LOGO from '../../images/re.png'
import ClothingDetail from '../Data/detail';


function QuickReebok({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Reebok').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='reebok'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:'50x',color:'grey'}} src={NF_LOGO}></img></a> 
