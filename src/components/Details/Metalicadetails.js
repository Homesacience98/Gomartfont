...
import NF_LOGO from '../../images/m.png'
import ClothingDetail from '../Data/detail';


function QuickMetalica({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Metalica').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='metalica'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:' 50x',color:'grey'}} src={NF_LOGO}></img></a> 
