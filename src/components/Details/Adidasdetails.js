...
import NF_LOGO from '../../images/logoad.png'
import ClothingDetail from '../Data/detail';


function QuickAdidas({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Adidas').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='adidas'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:'40x',color:'grey'}} src={NF_LOGO}></img></a> 
