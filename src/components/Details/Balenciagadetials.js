...
import NF_LOGO from '../../images/logobal.jpg'
import ClothingDetail from '../Data/detail';


function QuickBalenciaga({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Balenciaga').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='balenciaga'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:'40px',color:'grey'}} src={NF_LOGO}></img></a> 
...
export default QuickBalenciaga;
