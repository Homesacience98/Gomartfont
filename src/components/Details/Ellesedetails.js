...
import NF_LOGO from '../../images/logoell.png'
import ClothingDetail from '../Data/detail';


function QuickEllesse({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Ellesse').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='ellesse'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:' 40x',color:'grey'}} src={NF_LOGO}></img></a> 
