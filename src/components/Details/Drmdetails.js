...
function QuickDrm({ item }) {
  ...
  const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Drm').slice(0 ,8).map((maleclothesItem) => (
  ...
  return (
    <div>
        <a  href='drm'>  <img   style={{ backgroundColor: "" ,padding:'', border:'solid 2px ',width:'50px',height:' 40',color:'grey'}} src={NF_LOGO}></img></a> 
