...
function FemaleBags({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'F'&&  maleclothesItem.group==='BAGS').map((maleclothesItem) => (
    <Col
  ...
  return (
    <div  className='container'>
        <Search/>
        <hr/>
 <h6> &nbsp; Women Bag <i style={{color:'pink'}} class="fa fa-suitcase fa-spin "></i>
 </h6>
