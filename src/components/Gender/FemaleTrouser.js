...
function FemaleTrouser({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'F'&&  maleclothesItem.group==='TROUSER').map((maleclothesItem) => (
    <Col
 ...
 <h6> &nbsp;  Women Trousers  <i style={{color:'pink'}} class="fa fa-life-ring fa-spin "></i>
 </h6>
