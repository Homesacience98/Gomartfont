...
function FemaleTshirt({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'F'&&  maleclothesItem.group==='TSHIRT').map((maleclothesItem) => (
    <Col
 ...
 <h6> &nbsp;  Women Tshirt <i style={{color:'pink'}} class="fa fa-tshirt fa-spin "></i>
 </h6>
