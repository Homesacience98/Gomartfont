...
function MaleTrouser({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'M'&&  maleclothesItem.group==='TROUSER').map((maleclothesItem) => (
    <Col
 ...
 <h6> &nbsp;  Men Trousers   <i class="fa fa-star fa-spin text-success "></i>
 </h6>
