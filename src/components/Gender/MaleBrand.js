...
const applyFilters = (filters) => {
  ...
  return (
    <div className="container">
      <Search/>
      <hr/>
 <h6> &nbsp;  {brandName}   <i class="fa fa-gear fa-spin  text-success" ></i> </h6>
      ...
      <div className="row">
        {filteredProducts.filter((product) =>  product.gender === 'M' && product.brand=== brand).map((product) => (
