...
function MaleTshirt({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'M'&&  maleclothesItem.group==='TSHIRT').map((maleclothesItem) => (
    <Col
  ...
  return (
    <div  className='container'>
        <Search/>
        <hr/>
 <h6> &nbsp;  Men Tshirt  <i class="fa fa-tshirt fa-spin  text-success"></i> </h6>
