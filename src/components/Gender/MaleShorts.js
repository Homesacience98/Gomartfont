...
function MaleShorts({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'M'&&  maleclothesItem.group==='SHORTS').map((maleclothesItem) => (
    <Col
  ...
  return (
    <div  className='container'>
        <Search/>
        <hr/>
 <h6> &nbsp;  Male Shorts         <i class="fa fa-life-ring fa-spin  text-success "></i>
</h6>
