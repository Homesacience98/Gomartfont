...
function FemaleShorts({ item }) {
  ...
  const maleCardList = filteredProducts.filter((maleclothesItem) => maleclothesItem.gender === 'F'&&  maleclothesItem.group==='SHORTS').map((maleclothesItem) => (
    <Col
  ...
  return (
    <div  className='container'>
        <Search/>
        <hr/>
 <h6> &nbsp;  Female Shorts         <i style={{color:'pink'}} class="fa fa-life-ring fa-spin  "></i>
</h6>
