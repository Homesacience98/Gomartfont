...
function Converse() {
  ...
  const handleAddToCart = (item) => {
    ...
    const prevCount = parseInt(localStorage.getItem('count')) || 0;
  ...
  useEffect(() => {
    ...
    const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Converse').map((maleclothesItem) => (
  ...
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/-DioWW2BUOg"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
<hr/>

            <a href="/converse">

            <img  class="col-md-4 col-sm-4 col-4"  style={{ backgroundColor: "" ,padding:'5px', border:'solid 1px white  ',width:'120px',height:'120px'}} src={S_LOGO}></img>
</a>
