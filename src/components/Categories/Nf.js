...
function NF() {
  ...
  useEffect(() => {
    ...
    const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Northface').map((maleclothesItem) => (
  ...
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/2KToPCh77ZM"   frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
<hr/>

            <a href="/nf">

            <img  class="col-md-4 col-sm-4 col-4"  style={{ backgroundColor: "" ,padding:'5px', border:'solid 1px white  ',width:'120px',height:'120px'}} src={NF_LOGO}></img>
</a>
