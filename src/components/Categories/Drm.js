...
function Drm() {
  ...
  useEffect(() => {
    ...
    const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Drm').map((maleclothesItem) => (
  ...
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/eIGb7KPIlGA"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
<hr/>

            <a href="/drm">

            <img  class="col-md-4 col-sm-4 col-4"  style={{ backgroundColor: "" ,padding:'5px', border:'solid 1px white  ',width:'120px',height:'120px'}} src={DM_LOGO}></img>
</a>
