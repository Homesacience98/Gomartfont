...
function Hublot() {
  ...
  useEffect(() => {
    ...
    const maleCardList = products.filter((maleclothesItem) => maleclothesItem.brand === 'Hublot').map((maleclothesItem) => (
      ...
      >
        <Card style={{ width: '268px', marginBottom: '5px',border: '0.1px solid white ' }}>
          <Card.Img
            ...
            style={{ width: '267px', height: '370px',padding: ''}}
  ...
  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/jPn_SYRP3rE" title='Hublot'   frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
<br/>

            <a href="/hublot">
  <img class="col-md-4 col-sm-4 col-4" style={{ backgroundColor: "", padding: '5px', border: 'solid 1px white', width: '120px', height: '120px' }} src={HUB_LOGO} alt="Hub Logo" />
</a>
